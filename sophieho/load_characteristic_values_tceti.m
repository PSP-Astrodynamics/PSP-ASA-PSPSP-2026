function [tceti_star] = load_characteristic_values_tceti_star()
    ...
    tceti_h.e = 0.23;
    tceti_h.theta_star = 143; %[km/s]
end

planet_h = [tceti_h.mu, tceti_h.a, tceti_h.e, tceti_h.theta_star]
planet_g = [tceti_g.mu, tceti_g.a, tceti_g.e, tceti_g.theta_star]
planet_f = [tceti_f.mu, tceti_g.a, tceti_g.e, tceti_g.theta_star]
